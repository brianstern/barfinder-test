window.onload = function () {
    ...
    function addBar(stage, system, x, y, w, h, lines, number) {       
    ...
    imageObj.onload = function () {
        ...
        $.get('static/mei/C_07a_ED-Kl_1_A-Wn_SHWeber90_S_009.mei', function(data) {
            ...
            mei.find("section").children().each(function() {
                if ($(this).is("sb")) {
                    ...
                    addBar(stage, currSystem, ulX, ulY, width, height, staffEnds, $(this).attr("n"));
                }
            });
            resizeSystem(currSystem);
            stage.draw();
